...
%% Section 11 - Direction Shear and Probability Plot
    ...
    [PDFs] = ShearCharacterization(D.Veer,T,PLFull,PLInflec,'PlotOn');          % Calculate and plot PDF for direction and speed shear
...
PlotSelections(P,data,Dist,D,T,WindBins,Mean,STD,Num,AB,AlphaBeta)
